<?php
	...
	class SQL {
		...
		public function __construct() {
			...
			$this->db = new PDO(DRIVER . ':host='. SERVER . ';port=3307;dbname=' . DB, USERNAME, PASSWORD);
       ...
       /* public function addOrder ($table, $object) {
            $columns = array();
        ...
        public function SelectOrders($table, $object) {
